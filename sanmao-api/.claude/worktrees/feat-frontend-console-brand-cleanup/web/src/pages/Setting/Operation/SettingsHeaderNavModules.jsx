  ...
  useEffect(() => {
    ...
    if (props.options && props.options.HeaderNavModules) {
      try {
        ...
        delete supportedModules.docs;
        delete supportedModules.about;
        setHeaderNavModules({
          home: supportedModules.home ?? true,
          console: supportedModules.console ?? true,
          pricing: supportedModules.pricing ?? {
            enabled: true,
            requireAuth: false,
          },
        });

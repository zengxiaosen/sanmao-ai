        ...
        <div className='flex flex-col md:flex-row items-center justify-between w-full max-w-[1110px] gap-6'>
          <div className='flex flex-col items-start gap-2'>
            <div className='flex flex-wrap items-center gap-2'>
              <span className='inline-flex items-center rounded-full border border-emerald-400/30 bg-emerald-400/10 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-emerald-300'>
                Console
              </span>
              <Typography.Text className='text-sm !text-semi-color-text-1'>
                {t('面向模型转发、额度管理与商业化运营的中转工作台')}
              </Typography.Text>
            </div>
            <Typography.Text className='text-sm !text-semi-color-text-1'>

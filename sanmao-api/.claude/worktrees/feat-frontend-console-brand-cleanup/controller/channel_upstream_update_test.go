...
func TestCollectPendingUpstreamModelChangesFromModels_KeepsLegacyAliasWhenMapped(t *testing.T) {
	pendingAddModels, pendingRemoveModels := collectPendingUpstreamModelChangesFromModels(
		[]string{"deepseek-chat", "deepseek-v4-pro", "qwen3.7-plus"},
		[]string{"deepseek-v4-pro", "deepseek-v4-flash", "qwen3.7-plus"},
		nil,
		map[string]string{
	...
	require.Equal(t, []string{"deepseek-v4-flash"}, pendingAddModels)
	require.Equal(t, []string{}, pendingRemoveModels)
}

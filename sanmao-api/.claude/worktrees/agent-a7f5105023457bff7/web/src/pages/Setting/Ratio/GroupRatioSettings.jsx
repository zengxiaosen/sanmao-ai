    ...
    <Spin spinning={loading}>
      ...
      >
        <Banner
          ...
          title={t('用户组折扣怎么填')}
          description={t('默认用户填 1，VIP 填 0.95，SVIP 填 0.9。数字越小，这个用户组看到的价格越便宜。')}
        />
        <Row gutter={16}>
          <Col xs={24} sm={16}>
            <Form.TextArea
              ...
              extraText={t(
                '这里就是不同用户组的价格折扣。1 表示原价，0.95 表示打 95 折，0.9 表示打 9 折。',
              )}
              field={'GroupRatio'}
        ...
        <Collapse>
          <Collapse.Panel header={t('用户组高级设置（通常不用改）')} itemKey='advanced-group'>
            <Row gutter={16}>
              <Col xs={24} sm={16}>
                <Form.TextArea
                  label={t('用户可选分组')}

...
func SetRelayRouter(router *gin.Engine) {
	...
	{
		responsesByIDRouter := relayV1Router.Group("")
		responsesByIDRouter.Use(middleware.ResolveResponseRoute())
		responsesByIDRouter.Use(middleware.Distribute())
		responsesByIDRouter.GET("/responses/:response_id", controller.RelayResponsesByID)
		responsesByIDRouter.DELETE("/responses/:response_id", controller.RelayResponsesByID)
	}
	{
		//http router

...
func GetLogsStat(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"data": gin.H{
			...
			"rpm":                    stat.Rpm,
			"tpm":                    stat.Tpm,
			"upstream_cost_quota":    stat.UpstreamCostQuota,
			"usage_cost_quota":       stat.UsageCostQuota,
			"fixed_cost_quota":       stat.FixedCostQuota,
			"net_profit_quota":       stat.NetProfitQuota,
			"profit_rate":            stat.ProfitRate,
			"cost_configured":        stat.CostConfigured,
			"cost_configured_logs":   stat.CostConfiguredLogs,
			"cost_unconfigured_logs": stat.CostUnconfiguredLogs,
		},
	})
	return
}
...
func GetLogsSelfStat(c *gin.Context) {
	...
	c.JSON(200, gin.H{
		...
		"data": gin.H{
			...
			"rpm":                    quotaNum.Rpm,
			"tpm":                    quotaNum.Tpm,
			"upstream_cost_quota":    quotaNum.UpstreamCostQuota,
			"usage_cost_quota":       quotaNum.UsageCostQuota,
			"fixed_cost_quota":       quotaNum.FixedCostQuota,
			"net_profit_quota":       quotaNum.NetProfitQuota,
			"profit_rate":            quotaNum.ProfitRate,
			"cost_configured":        quotaNum.CostConfigured,
			"cost_configured_logs":   quotaNum.CostConfiguredLogs,
			"cost_unconfigured_logs": quotaNum.CostUnconfiguredLogs,
			//"token": tokenNum,
		},
	})
	return

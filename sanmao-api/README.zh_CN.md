...
针对本机 `Claude Code` / `Codex CLI` 通过 `sanmao-api` 做统一网关的场景，可直接参考：

- [本机 Claude/Codex 接入指南](./docs/installation/local-claude-codex.md)
- [服务器状态记录](./docs/installation/server-state-2026-05-18.md)
- [本地同步并部署到阿里云脚本](./scripts/deploy-and-sync.sh)
- [本地 SSH 隧道脚本](./scripts/start-local-tunnel.sh)

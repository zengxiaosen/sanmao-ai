...
case "$MODEL_ALIAS" in
  qwen3-14b-awq)
    ...
    ;;
  qwen3-8b-awq)
    echo "qwen3-8b-awq has been retired from this repo's active workflow." >&2
    echo "Use the Qwen3-Coder vLLM path instead:" >&2
    echo "  bash scripts/env/setup_qwen3_coder_vllm.sh" >&2
    echo "  bash scripts/env/start_qwen3_coder_vllm.sh" >&2
    exit 2
    ;;
  qwen3-32b-awq)
